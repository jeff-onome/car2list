            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-3 w-56 bg-zinc-950 rounded-2xl border border-white/10 shadow-2xl py-2 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="bg-zinc-950">
                  {user?.role === 'USER' && (
                    <>
                      <DropdownItem to="/user/garage" icon="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" label="My Cars" onClick={() => setIsDropdownOpen(false)} />
                      <DropdownItem to="/user/profile" icon="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" label="Settings" onClick={() => setIsDropdownOpen(false)} />
                    </>
                  )}
